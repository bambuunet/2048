...
function init(){
  ...
  wih = getCsv('./csv/layer3/wih.csv');
  whh = getCsv('./csv/layer3/whh.csv');
  who = getCsv('./csv/layer3/who.csv');
}
...
function calcNeuron(){
  ...
  var hiddenInputs2 = calcDot(whh, hiddenOutputs);
  var hiddenOutputs2 = calcSigmoidMatrix(hiddenInputs2);
  var finalInputs = calcDot(who, hiddenOutputs2);
